...
public class altype implements KeyListener, collection {
    ...
    public altype(JFrame window, JMenuBar menubar){
		...
		usability.setHorizontalAlignment(JLabel.CENTER);
		usability.setForeground(Color.white);
		usability.setFont(new Font("Courier New", Font.PLAIN, 18));
		usability.setVerticalAlignment(SwingConstants.CENTER);
		usability.setText("<html><p style=\"width:300px;text-align:center\">wpm:   <br> acc:   </p></html>");    	

				
    	//placement of labels
    	Container c = window.getContentPane();
        window.add(text_output); 
        window.add(usability);
